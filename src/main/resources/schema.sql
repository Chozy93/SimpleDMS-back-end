...
CREATE SEQUENCE SQ_DEPT START WITH 1 INCREMENT BY 1;

DROP SEQUENCE SQ_BOOK;
CREATE SEQUENCE SQ_BOOK START WITH 1 INCREMENT BY 1;

DROP SEQUENCE SQ_BOOKER;
CREATE SEQUENCE SQ_BOOKER START WITH 1 INCREMENT BY 1;
...
DROP TABLE TB_BOOKER CASCADE CONSTRAINT;
...
(
    BKNO         NUMBER NOT NULL PRIMARY KEY,
    DESTINATION       VARCHAR2(255),
    SCHEDULE         VARCHAR2(255),
    PRICE       NUMBER,
    MANAGER     VARCHAR2(255),
